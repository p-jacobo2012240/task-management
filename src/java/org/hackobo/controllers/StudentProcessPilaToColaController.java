 ...
 * @author Hackobo
 */
@WebServlet(name = "StudentProcessPilaToColaController", urlPatterns = {"/StudentProcessPilaToColaController"})
public class StudentProcessPilaToColaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if( !this.auxStuatus.isEmpty()){
                StudentCola.getInstance().execOPT();
                ...
                for(Students s : studentColaTemp  ){
